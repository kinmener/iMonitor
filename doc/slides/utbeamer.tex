...
\pgfdeclareimage[height=1.0cm]{utbig}{fig/UTWordmark}
\pgfdeclareimage[height=0.6cm]{ut}{fig/UTWordmark}
...
\institute[UT Austin] 
{
    ...
    %\pgfuseimage{utbig} 
    \includegraphics[height=1cm]{fig/UTWordmark}
}
\date[PLDI 2013]
%{\pgfuseimage{sclogo} }
...
\begin{frame}[fragile]
    ...
    \end{lstlisting}
    {\hfill \includegraphics[width=0.36\linewidth]{fig/cb}}
\end{frame}
