...
plot  "TicketReadersWriters/explicit.dat" using 2:xticlabels(1) title 'explicit' with linespoints, \
      "TicketReadersWriters/set.dat" using 2:xticlabels(1) title 'iMonitor-T' with linespoints, \
      "TicketReadersWriters/tag.dat" using 2:xticlabels(1) title 'iMonitor' with linespoints
