...
\end{enumerate}
%garbage collection v.s. programers manually free memory
...
%we give reasons for the efficiency in implict signaling.
...
%for synchronzation problems with signalAll.
...
%% NEERAJ: \section{Prior NSF Results} 
...
%\begin{definition}
%    A odering $<<$ is defined as follows
%\[
%    (c_1, \diamond_1) << (c_2, \diamond_2)
%\]
%if and only if $c_1 < c_2$ or $c_1 = c_2$ and $\diamond_1 = \ge$ and
%$\diamond_2 = >$ or $\diamond_1 = <$ and $\diamond_2 = \le$.
%
%\end{definition}
%\begin{proposition}
%\end{proposition}
