...
public  class IdealImplicitBoundedBuffer implements ObjectBoundedBufferInterface {
  private NaiveImplicitMonitor monitor = new NaiveImplicitMonitor(); //auto-gen
  private ImplicitCondition cond_1 = monitor.makeCondition( //auto-gen
      new  Assertion() {
           public boolean isTrue() { return count > 0; } } ) ;
  private ImplicitCondition cond_0 = monitor.makeCondition( //auto-gen
      new  Assertion() {
