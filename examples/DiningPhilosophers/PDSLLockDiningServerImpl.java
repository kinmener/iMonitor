...
public class PDSLLockDiningServerImpl extends DiningServer {
   ...
   /**
     ...
     */
   private PDSLLockDiningServerImpl(int numPhils) {
      super(numPhils);
      mutex = new PDSLLock();
   }
   ...
   public static DiningServer newInstance(int numPhils) {
      DiningServer instance = new PDSLLockDiningServerImpl(numPhils);
      return instance;
   }
