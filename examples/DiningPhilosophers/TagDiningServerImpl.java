...
import monitor.*;	//auto-gen Tag

public class TagDiningServerImpl extends DiningServer {

    private TagMonitor __monitor__628 = new TagMonitor(); //auto-gen
    /**

     * Constructor.
     * @param numPhils The number of dining philosophers.
     */
    private TagDiningServerImpl(int numPhils) {
        super(numPhils);
    }
    ...
    public static DiningServer newInstance(int numPhils) {
        DiningServer instance = new TagDiningServerImpl(numPhils);
        return instance;
    }
    ...
    private void test(int k) { 
        ...
        protected void takeForks(int i) throws InterruptedException { 
            ...
            __monitor__628.DoWithin( new RunnableWithException<InterruptedException>() { public void run() throws InterruptedException {
                ...
                AbstractCondition cond_1 = __monitor__628.makeCondition( 
